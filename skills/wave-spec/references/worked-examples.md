...
**Сценарий:** доработать лендинг [client-landing]: добавить блок отзывов, поправить квиз, обновить FAQ. 3 задачи, без fidelity-порта → dual review рекомендован, но не обязателен (writer≠reviewer минимум).
