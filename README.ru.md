...
Коллекция скиллов для агентов [opencode](https://github.com/opencode-ai/opencode) (DeepSeek V4, Claude, GPT).

Каждый скилл — это набор инструкций, промпт-паттернов и справочных материалов, которые обучают AI-агента эффективно выполнять конкретную задачу.
