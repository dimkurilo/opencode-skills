...
| [project-orchestra](skills/project-orchestra/) | **v1.1 - несколько агентов на одном продукте.** Сначала смотрит папку, при нужде задаёт вопросы, потом общая память, темы-подпапки, волны и файл «можно делать». Режимы: `full`, `workstream-new`, `wave`, `bootstrap-lite`, review/execute, `extend`. Удобно с [Orca](https://onorca.dev). [Подробнее](skills/project-orchestra/README.ru.md) |
...
└── skills/
    ...
    ├── project-orchestra/  # Несколько агентов на одном продукте (v1.1)
